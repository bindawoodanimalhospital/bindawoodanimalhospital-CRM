...
begin
  for r in select * from (values
    ...
    ('diagnostic_orders', 'diagnostic_code_seq'), ('surgeries', 'surgery_code_seq'), ('admissions', 'admission_code_seq'), ('purchases', 'purchase_code_seq'), ('payments', 'receipt_code_seq')) as t(tbl, seq)
  loop
